...
def create_backup():
    ...
    backup_dir = f'./backups/Aki {__status__} {__version__} {time}'
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                shutil.copy2('__init__.py', backup_dir)
                for dir in backups:
                ...
                try:
                    ...
                    logger.error(f'Не удалось создать архив {backup_dir} - Пользователь: SYSTEM')
            except:
